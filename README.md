...
-   [Source list Update](./geral/source.list-update.md)
...
-   [Yarn install](./geral/yarn-install.md)
-   [Docker install](./geral/docker-install.md)
-   [Docker compose install](./geral/docker-compose-install.md)
-   [Nginx install and configure](./geral/nginx-install-and-configure.md)
-   [Create daemon service](./geral/create-daemon-service-spring-boot.md)
